...
const routes = [
  ...
  { path: "/org", component: WorkspaceLayout, meta: orgMeta, children: [
    ...
    { path: "finance", name: "org-finance", component: () => import("../views/org/OrgFinanceView.vue"), meta: { title: "收款与退款" } },
  ...
  { path: "/admin", component: WorkspaceLayout, meta: adminMeta, children: [
    ...
    { path: "finance", name: "admin-finance", component: () => import("../views/admin/AdminFinanceView.vue"), meta: { title: "平台财务" } },
  ] },
