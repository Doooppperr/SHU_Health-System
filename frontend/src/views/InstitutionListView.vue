<template>
  <div class="workspace-page user-platform-page institution-directory">
    ...
    <section class="institution-search-panel" aria-label="搜索体检机构">
      ...
      <small v-else>支持机构、分院、套餐、人群、健康方向与交通信息智能搜索</small>
    </section>
