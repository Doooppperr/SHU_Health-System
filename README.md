...
验收快照包含 25 个账号、5 个机构主体、15 家分院、26 个套餐、40 个预约组、56 位预约参与者及 79 份已归档体检报告。全部 200 个“报告—健康方向”组合均有机构医生审核结论，并通过套餐、指标、附件和结论事实对齐校验。`test1` 保持 41 份报告，对全部 104 个活动指标均至少有 9 条，核心趋势指标均有 16 条，覆盖 1458 天（9 次综合体检、20 次专项或联合复查），并包含早期轻度代谢风险、中期改善、阶段性反弹、近期轻度体重关注，以及正常、偏高、偏低、阳性/阴性、OCR/手工、多机构、同日优先级和规范附件批注。完整账号矩阵见[验收账号与预置数据](项目文档/验收账号与预置数据.md)。
...
当前验收基线：后端 96 项、前端 130 项测试通过，Vite production build 通过，Python 生产依赖清单与前端生产依赖审计均无已知漏洞；SQLite schema v10、v9→v10 原子升级、openGauss v10 迁移、预置业务数据预检与覆盖流程均已验证。
