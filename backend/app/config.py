...
class Config:
    ...
    CATALOG_AI_GUEST_RATE_LIMIT_PER_MINUTE = int(os.getenv("CATALOG_AI_GUEST_RATE_LIMIT_PER_MINUTE", "10"))
    CATALOG_AI_AUTH_RATE_LIMIT_PER_MINUTE = int(os.getenv("CATALOG_AI_AUTH_RATE_LIMIT_PER_MINUTE", "30"))
    CATALOG_AI_CONNECT_TIMEOUT_SECONDS = float(os.getenv("CATALOG_AI_CONNECT_TIMEOUT_SECONDS", "2"))
    CATALOG_AI_READ_TIMEOUT_SECONDS = float(os.getenv("CATALOG_AI_READ_TIMEOUT_SECONDS", "4"))
    CATALOG_AI_CACHE_TTL_SECONDS = int(os.getenv("CATALOG_AI_CACHE_TTL_SECONDS", "600"))
    CATALOG_AI_CACHE_SIZE = int(os.getenv("CATALOG_AI_CACHE_SIZE", "256"))
...
class TestingConfig(Config):
    ...
    CATALOG_AI_GUEST_RATE_LIMIT_PER_MINUTE = 1000
    CATALOG_AI_AUTH_RATE_LIMIT_PER_MINUTE = 1000
    RAG_USE_MOCK = True
    AGENT_ENABLED = True
